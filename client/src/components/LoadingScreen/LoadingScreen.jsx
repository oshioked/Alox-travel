    ...
    return(
        <div ref = {screenRef} theme = {currentTheme} className = "loading-screen">
            <div  className = 'alox-icon'>
                ...
                <path fillRule="evenodd" clipRule="evenodd" d="M12 0H22L32.5 30V0H42.5V34H23L21 28H12.5L10.5 34H0L12 0ZM20.5 2H13.5L2.5 32H9L11 26H22.5L24.5 32H31L20.5 2ZM16.5 9L13 20.5H20.5L16.5 9ZM16.5 15L15.5 18.5H17.5L16.5 15ZM40.5 32H34.5V2H40.5V32Z" fill="red"/>
